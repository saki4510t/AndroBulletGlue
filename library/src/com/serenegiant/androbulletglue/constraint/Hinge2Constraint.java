 ...
 * 
 * File name: Hinge2Constraint.java
*/
/*
...
public class Hinge2Constraint extends Generic6DofSpringConstraint {

	protected final Vector3 mAnchor;
	protected final Vector3 mAxis1;
	protected final Vector3 mAxis2;
	
	public Hinge2Constraint(PhysicsWorld world,
	...
	public void setUpperLimit(float ang1max) {
		setAngularUpperLimit(-1.f, 0.f, ang1max);
	}
	
	public void setLowerLimit(float ang1min) {
		setAngularLowerLimit(1.f, 0.f, ang1min);
	}
