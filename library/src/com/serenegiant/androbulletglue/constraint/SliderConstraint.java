 ...
 * 
 * File name: SliderConstraint.java
*/
/*
...
public class SliderConstraint extends Constraint {
	...
	public SliderConstraint(PhysicsWorld world,
	...
	public SliderConstraint(PhysicsWorld world,
		...
		super(world, SLIDER_CONSTRAINT_TYPE);
		mRbA = rbA;
		mRbB = rbB;
		mFrameA.set(frameInA);
		mFrameB.set(frameInB);
		
		createConstraint(frameInA, frameInB, useLinearReferenceFrameA,
