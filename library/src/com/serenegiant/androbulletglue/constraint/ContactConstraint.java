 ...
 * 
 * File name: ContactConstraint.java
*/
/*
...
public class ContactConstraint extends Constraint {
	...
	public ContactConstraint(PhysicsWorld world) {
		super(world, CONTACT_CONSTRAINT_TYPE);
		throw new IllegalArgumentException("ContactConstraint is not supported now");
	}
}
