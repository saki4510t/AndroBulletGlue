...
public class Box2dShape extends PolyhedralConvexShape {
	
	public final Vector3 boxHalfExtents;
	
	public Box2dShape(PhysicsWorld world, Vector3 boxHalfExtents) {
		super(world, BOX_2D_SHAPE_PROXYTYPE);
