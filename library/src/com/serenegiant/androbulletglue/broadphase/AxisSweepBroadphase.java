 ...
 * 
 * File name: AxisSweepBroadphase.java
*/
/*
...
public class AxisSweepBroadphase extends Broadphase {
	...
	public AxisSweepBroadphase() {
		this(null, null, 16384);
	}
			
	public AxisSweepBroadphase(Vector3 worldAabbMin, Vector3 worldAabbMax, int maxProxies) {
		
		super(BROADPHASE_AXISSWEEP3);
